...
Feature: As an admin, I can create a Scrum project and ass user to it and I can create different epics as a team lead user
  Scenario Outline: Project management API Test
    ...
    Examples:
      ...
      | "Eva" | "12345"  | "Eva@atlassian.com" | "Eva of Atlassian" | "jira-core"     | 10002         | "SCP"      | "Scrum Project" | "software"     | "com.pyxis.greenhopper.jira:gh-scrum-template" | "Scrum Project description" | "Junyu Deng" | "http://atlassian.com" | "PROJECT_LEAD" | 10000            | "Frontend dev" | "Backend dev" | "UI/UX design" | "Testing" |

#Since its is difficult to get the user account id in jira,
  # i set a default user account is as "10002" which the first user created in jira except admin user
