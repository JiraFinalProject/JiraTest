...
public class CurrentProjectStepDefs {
    ...
    @And("I enter user {string} and press return in search bar of add users to a role window")
    public void iEnterUserUsernameInSearchBarOfAddUsersToARoleWindow(String username) {
    ...
    public void iClickCreateButtonOnTheTopBanner() {
