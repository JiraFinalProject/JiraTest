...
//        }
    ...
    @And("I type in To Do")
    public void i_type_in_to_do() throws InterruptedException {
...
//        driver.manage().timeouts().implicitlyWait(120, TimeUnit.SECONDS);
    ...
    public void i_type_in_in_progress() throws InterruptedException {
        try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
            // Handle the exception if necessary
...
//    }
    ...
    public void i_type_in_resolved() throws InterruptedException {
        try {
            Thread.sleep(5000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
            // Handle the exception if necessary
...
//    }
    ...
    public void i_type_in_closed() throws InterruptedException {
        try {
            Thread.sleep(3000); // 5000 milliseconds = 5 seconds
        } catch (InterruptedException e) {
            // Handle the exception if necessary
