...
public class ScrumBoardPO extends BasePO{
    @FindBy(xpath = "//img[@alt='User profile for Jade Yang']")
...
//    @FindBy(css =  ".ghx-issues:eq(1) div")
    @FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/main[1]/div[2]/div[2]/div[1]/div[1]/ul[2]")
    ...
    @FindBy(xpath = "//ul[@class='ghx-column-wrapper ghx-config-status ghx-mapped ghx-last ui-sortable']//span[@class='aui-icon aui-icon-small aui-iconfont-delete js-column-delete']")
