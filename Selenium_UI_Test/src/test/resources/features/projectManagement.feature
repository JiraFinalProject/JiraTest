...
#    And I enter lead <leadUsername> in the project lead input field        <--- jira website new update?? no lead input anymore, default to the user who is creating this project as lead
    ...
    Examples:
      ...
      | "meina"       | "bEW$4@Aue3AGkG3" | "Scrum Project" | "meina"         | "Charlie" | "Administrator" | "Frontend dev" | "Backend dev" | "UI/UX design" | "Testing" |
